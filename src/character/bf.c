...
Character *Char_BF_New(fixed_t x, fixed_t y)
{
	...
	this->character.focus_y = (stage.stage_id == StageId_1_2 || stage.stage_id == StageId_1_3 || stage.stage_id == StageId_3_2) ? FIXED_DEC(-103,1) : FIXED_DEC(-85,1);
	this->character.focus_zoom = (stage.stage_id == StageId_1_2 || stage.stage_id == StageId_1_3 || stage.stage_id == StageId_3_2) ? FIXED_DEC(9,10) : FIXED_DEC(1,1);
